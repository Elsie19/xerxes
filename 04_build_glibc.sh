...
info_print "*** BUILD GLIBC BEGIN ***"

# Prepare the work area, e.g. 'work/glibc/glibc_objects'.
info_print "Preparing glibc object area. This may take a while."
rm -rf "$GLIBC_OBJECTS"
mkdir "$GLIBC_OBJECTS"

# Prepare the install area, e.g. 'work/glibc/glibc_installed'.
info_print "Preparing glibc install area. This may take a while."
