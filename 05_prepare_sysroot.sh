...
info_print "*** PREPARE SYSROOT BEGIN ***"

info_print "Cleaning existing sysroot. This may take a while."
rm -rf "$SYSROOT"
mkdir -p "$SYSROOT"

info_print "Preparing glibc. This may take a while."
...
info_print "*** PREPARE SYSROOT END ***"
