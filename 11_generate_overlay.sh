...
info_print "*** GENERATE OVERLAY BEGIN ***"

# Remove the old ISO image overlay area.
info_print "Removing old overlay area. This may take a while."
...
info_print "Using sparse file for overlay."
  ...
  info_print "Using folder structure for overlay."
...
info_print "*** GENERATE OVERLAY END ***"
